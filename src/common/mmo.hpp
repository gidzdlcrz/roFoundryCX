...
#define MAX_PARTY 5 ///Max party member // Max Party Capped into 5 [Cross]
#define MAX_GUILD 16+10*1	///Increased max guild members +6 per 1 extension levels [Lupus] // Guild Capacity Capped into 26 [Cross]
